package advanced.dynamic_proxy;
...
public class jdk_proxy implements InvocationHandler {
    ...
    public static void main(String[] args) throws Exception {
        Class<?> clazz = Class.forName("advanced.dynamic_proxy.service_demo_impl");
        service_demo service_demo_proxy = (service_demo)Proxy.newProxyInstance(clazz.getClassLoader(), new Class<?>[] { advanced.dynamic_proxy.service_demo.class} , new jdk_proxy());
