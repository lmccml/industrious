...
public class reflect_test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //------------------------------获取私有字段****并调用-------------------------------------------
        Class clazz_second = Class.forName("practice.reflection.test_class");//注意此字符串必须是真实路径，就是带包名的类路径，包名.类名
        //2.获取字段
        ...
        //--------------------------------------获取私有的方法并调用--------------------------------------------------
        //1.获取Class对象
        Class clazz_third = Class.forName("practice.reflection.test_class");//注意此字符串必须是真实路径，就是带包名的类路径，包名.类名
        //2.获取方法
        ...
        try {
            //1、获取Student对象的字节码
            Class clazz = Class.forName("practice.reflection.test_class");
