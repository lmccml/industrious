...
public class get_class_obj {
    public static void main(String[] args) throws Exception {
        ...
        clazz_third = Class.forName("practice.class_loader.test_class");

        //这两个方法都可以用来加载目标类，它们之间有一个小小的区别，那就是 Class.forName() 方法可以获取原生类型的 Class，而 ClassLoader.loadClass() 则会报错。
        Class<?> clazz_fourth = null;
        clazz_fourth = get_class_obj.class.getClassLoader().loadClass("practice.class_loader.test_class");
